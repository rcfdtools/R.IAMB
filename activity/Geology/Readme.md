...
:pencil2: A partir de un script en Python, para cada Unidad Cronoestratigráfica, calcule la distribución porcentual respecto al total del área del proyecto.
