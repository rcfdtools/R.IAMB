...
| [:round_pushpin:qgis_unidadgeologica _homologador.py](../../file/src/qgis_unidadgeologica_homologador.py)     | Script en Python para homologación de atributos de unidades geológicas [ANLA](https://www.anla.gov.co/) a partir de las Unidades Cronoestratigráficas del Atlas Geológico de Colombia del [SGC](https://www.sgc.gov.co/). |
...
:pencil2:**Actividad:** A partir de un script en Python, para cada Unidad Cronoestratigráfica, calcule la distribución porcentual respecto al total del área del proyecto.
...
:pencil2:**Actividad:** Utilizando el procedimiento anteriormente explicado, cree y homologue la capa de ContactoGeologico. Investigue si esta capa puede ser homologada desde el AGC o el MGC.
...
:pencil2:**Actividad:** Utilizando el procedimiento anteriormente explicado, cree y homologue a través de un script en Python la capa de _EstructuraFallaLineam_.
