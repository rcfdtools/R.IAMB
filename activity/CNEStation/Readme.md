...
> El catálogo integrado y sus metadatos puede ser consultados y obtenido directamente desde el portal de [www.datos.gov.co](https://www.datos.gov.co/Ambiente-y-Desarrollo-Sostenible/Cat-logo-Nacional-de-Estaciones-del-IDEAM/hp9r-jxuu). Para la identificación de fuente de datos, desde el _Field Calculator_ establezca en un campo String (20) `CNESource = if("Entidad" = 'INSTITUTO DE HIDROLOGÍA METEOROLOGÍA Y ESTUDIOS AMBIENTALES', 'CNE', 'CNE_OE')` 
