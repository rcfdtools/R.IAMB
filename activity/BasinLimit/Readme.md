...
> Tenga en cuenta que los vectores en escala 1:25.000, deben ser descargados individualmente a partir de hojas cartográficas o descargados masívamente a través de los servicios WFS o REST. 
> 
> Guardar y descomprimir en las carpetas [/data/IGAC](../../data/IGAC) y [/data/EAAB](../../data/EAAB).

2. En QGIS, abra el mapa _/map/CaseStudy.qgz_ y guarde como  _/map/BsinLimit.qgz_. Cargue las capas de drenajes sencillos y corrientes de agua de las diferentes fuentes obtenidas y evalué la precisión de su digitalización a partir de las imágenes satelitales disponibles en los mapas base.
...
<div align="center"><img src="graph/QGIS_ExportFeatures1.png" alt="R.SIGE" width="100%" border="0" /></div>
...
<div align="center"><img src="graph/QGIS_AddLayer2.png" alt="R.SIGE" width="100%" border="0" /></div>
...
<div align="center"><img src="graph/QGIS_Dissolve1.png" alt="R.SIGE" width="100%" border="0" /></div>
...
<div align="center"><img src="graph/QGIS_Dissolve2.png" alt="R.SIGE" width="100%" border="0" /></div>

4. Cargue y visualice los diferentes mapas ráster generados en HEC-HMS.

Modelo digital de terreno ajustado con drenajes  
<div align="center"><img src="graph/QGIS_DEMReconditioned.png" alt="R.SIGE" width="100%" border="0" /></div>

Relleno y localización de sumideros  
<div align="center"><img src="graph/QGIS_DEMSink.png" alt="R.SIGE" width="100%" border="0" /></div>

Acumulación de flujo  
<div align="center"><img src="graph/QGIS_DEMFAC.png" alt="R.SIGE" width="100%" border="0" /></div>

Dirección de flujo  
<div align="center"><img src="graph/QGIS_DEMFDR.png" alt="R.SIGE" width="100%" border="0" /></div>
